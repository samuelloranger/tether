...
function ensureConnState(bag: SessionTransportBag, key: string): TerminalConnectionState {
...
function handleWsMessage(bag: SessionTransportBag, key: string, data: string): void {
