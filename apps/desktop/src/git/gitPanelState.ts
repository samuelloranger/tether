 ...
 */
export type ChangesPaneContent = { type: 'error'; message: string } | { type: 'empty' } | { type: 'files' };
...
export type LoadPaneContent = { type: 'error'; message: string } | { type: 'empty' } | { type: 'ready' };
